...
# disable velo
def draw_scenes(points, gt_boxes=None, ref_boxes=None, ref_scores=None, ref_labels=None, nusc=False):
    ...
    # draw grid
    # if nusc:
    #     fig = draw_multi_grid_range(fig, bv_range=(0, -40, 100, 40))
    # else:
    ...
    mlab.view(azimuth=-179, elevation=54.0, distance=124.0, roll=90.0)#'auto'
    return fig
