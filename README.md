...
Our **SRDAN**, Scale-aware and Range-aware Domain Adaptation Network for Cross-dataset 3D Object Detection is implemented based on `OpenPCDet`. Please see [README_SRDAN](README_SRDAN.txt) for more details.
