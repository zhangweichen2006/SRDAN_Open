...
class PointHeadSimple(PointHeadTemplate):
    ...
    """
    def __init__(self, num_class, input_channels, model_cfg, nusc=False, **kwargs):
        super().__init__(model_cfg=model_cfg, num_class=num_class, nusc=nusc)
    ...
    def forward(self, batch_dict, t_mode='det'):
        """
        Args:
            batch_dict:
                batch_size:
...
# class PointHeadSimple_Nusc(PointHeadTemplate):
#     """
#     A simple point-based segmentation head, which are used for PV-RCNN keypoint segmentaion.
#     Reference Paper: https://arxiv.org/abs/1912.13192
#     PV-RCNN: Point-Voxel Feature Set Abstraction for 3D Object Detection
