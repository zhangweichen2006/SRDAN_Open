...
class ATSSTargetAssigner(object):
    ...
    def assign_targets(self, anchors_list, gt_boxes_with_classes, use_multihead=False, dom_src=None, fpn_layer=None, dom_squeeze=True):
        """
        Args:
            anchors: [(N, 7), ...] (n,9)
            gt_boxes: (B, M, 8) #10 Nusc
        Returns:

        """

        # print("fpn_layer wrong", fpn_layer)
        # print("anchors_list", anchors_list.shape)
