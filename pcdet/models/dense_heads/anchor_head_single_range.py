...
class AnchorHeadSingleRange(AnchorHeadTemplate):
    def __init__(self, model_cfg, input_channels, num_class, class_names, grid_size, point_cloud_range,
        ...
        if self.joint_two_dom:
            ...
            print("input_channels_dom_joint", input_channels_dom_joint)
        ...
        if self.voxel_dom_patch_attention:
            self.att_patch_layer = PatchAttentionLayer(512, self.model_cfg.PATCH_SIZE)
        ...
        for layer in self.fpn_layers:
            ...
            if self.voxel_det_patch_attention and not self.joint_attention:
                self.att_patch_layer_det_fpn[layer] = PatchAttentionLayer(self.input_channels_fpn[layer], self.model_cfg.PATCH_SIZE)
            ...
            if self.voxel_dom_patch_attention:
                self.att_patch_layer_fpn[layer] = PatchAttentionLayer(self.input_channels_fpn[layer], self.model_cfg.PATCH_SIZE_FPN[layer])
