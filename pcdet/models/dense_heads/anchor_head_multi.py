...
class SingleHead(BaseBEVBackbone):
    def __init__(self, model_cfg, input_channels, num_class, num_anchors_per_location, code_size, encode_conv_cfg=None, nusc=False, head_label_indices=None, separate_reg_config=None, **kwargs):
