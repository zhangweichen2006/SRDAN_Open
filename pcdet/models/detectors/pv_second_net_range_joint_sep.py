...
class PVSECONDNetRangeJointSep(Detector3DTemplate):
    def __init__(self, model_cfg, num_class, dataset, nusc=False):
        ...
        self.range_inv = model_cfg.get('RANGE_INVATIANT', False)
    ...
    def get_training_loss(self, t_mode='det'):
        ...
        if 'det' in t_mode or 'pseudo' in t_mode:
            ...
            loss_rpn, tb_dict2 = self.dense_head.get_loss(tb_dict)
            ...
            # disp_dict = {
            #     'range_loss': tb_dict['point_loss_range'],
            #     **disp_dict
            # }
