...
def class_agnostic_nms(box_scores, box_preds, nms_config, score_thresh=None, nusc=False):
    ...
    if box_scores.shape[0] > 0:
        ...
        keep_idx, selected_scores = getattr(iou3d_nms_utils, nms_config.NMS_TYPE)(
            boxes_for_nms, box_scores_nms, nms_config.NMS_THRESH, **nms_config, nusc=nusc
        )
