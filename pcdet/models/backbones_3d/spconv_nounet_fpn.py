...
class NoUNetV2FPN(nn.Module):
    ...
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, num_fpn_up=0, num_fpn_down=0, num_fpn_downup=0, **kwargs):
        ...
        print("num_fpn_down", self.num_fpn_down)
    ...
    def forward(self, batch_dict):
        ...
        if self.FPN:
            ...
            if self.num_fpn_downup == 1:
                ...
                x_fpn4 = self.FPN_block_forward(x_conv4, x_conv5, self.conv4_ident, self.conv5_to_4, conv_t=self.conv_up_t5_to_4, conv_m=self.conv_up_m5_to_4)
