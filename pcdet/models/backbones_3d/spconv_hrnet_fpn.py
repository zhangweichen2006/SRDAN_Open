...
class HRNetFPN(nn.Module):
    ...
    """
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, num_fpn_up=0, num_fpn_down=0, num_fpn_downup=0, **kwargs):
        super().__init__()
        ...
        self.conv2_transition_up_1 = spconv.SparseSequential(
            block(16, 8, 3, norm_fn=norm_fn, indice_key='spconv1_down1', conv_type='inverseconv', no_relu=True)
        ...
        self.conv4_1 = spconv.SparseSequential(
            ...
            block(24, 16, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_1', conv_type='spconv'),
            block(16, 8, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_1'),
        )
        self.conv4_2 = spconv.SparseSequential(
            # [400, 352, 11] <- [200, 176, 5]
            block(48, 32, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_2', conv_type='spconv'),
            block(32, 16, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_2'),
        )
        self.conv4_3 = spconv.SparseSequential(
            # [400, 352, 11] <- [200, 176, 5]
            block(96, 64, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_3', conv_type='spconv'),
            block(64, 32, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_3'),
        )
        self.conv4_4 = spconv.SparseSequential(
            # [400, 352, 11] <- [200, 176, 5]
            block(192, 128, 3, norm_fn=norm_fn, padding=1, indice_key='spconv4_4', conv_type='spconv'),
