...
class HRNet2(nn.Module):
    ...
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, num_fpn_up=0, num_fpn_downup=0, **kwargs):
        ...
        self.nom = self.model_cfg.get('NOM', False)
        self.allsp = self.model_cfg.get('ALLSP', False)
        ...
        self.conv1 = spconv.SparseSequential(
            block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='conv1', conv_type='spconv' if self.allsp else 'subm'), 
        )
        ...
        self.conv2_1 = spconv.SparseSequential(
            block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='conv2_1', conv_type='spconv' if self.nom else 'subm'),
            # block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='subm2_12'),
        )
        self.conv2_2 = spconv.SparseSequential(
            block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='conv2_21',conv_type='spconv' if self.nom else 'subm'),
            block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='conv2_22',conv_type='spconv' if self.nom else 'subm'),
        )
        ...
        #     block(32, 16, 3, norm_fn=norm_fn, indice_key='spconv1_down1', conv_type='inverseconv', no_relu=True)
        # ) # can use conv and upsample 
        
        # layer 3 (stage)
        self.conv3_1 = spconv.SparseSequential(
            # [800, 704, 21] <- [400, 352, 11]
            block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='conv3_1', conv_type='spconv' if self.nom else 'subm'),
            # block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='subm3_12'),
        )
        self.conv3_2 = spconv.SparseSequential(
            # [800, 704, 21] <- [400, 352, 11]
            block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='conv3_2', conv_type='spconv' if self.nom else 'subm'),
            # block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='subm3_22'),
        )
        self.conv3_3 = spconv.SparseSequential(
            # [800, 704, 21] <- [400, 352, 11]
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='conv3_31', conv_type='spconv' if self.nom else 'subm'),
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='conv3_32', conv_type='spconv' if self.nom else 'subm'),
        )
        ...
        self.conv4_1 = spconv.SparseSequential(
            ...
            block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='subm4_11', conv_type='spconv' if self.nom else 'subm'),
        ...
        self.conv4_2 = spconv.SparseSequential(
            ...
            block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='subm4_21', conv_type='spconv' if self.nom else 'subm'),
        ...
        self.conv4_3 = spconv.SparseSequential(
            ...
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='subm4_31', conv_type='spconv' if self.nom else 'subm'),
        ...
        self.conv4_4 = spconv.SparseSequential(
            ...
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='subm4_41', conv_type='spconv' if self.nom else 'subm'),
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='subm4_42', conv_type='spconv' if self.nom else 'subm'),
        )
    ...
    def forward(self, batch_dict):
        ...
        x_final_out = self.cat_tensors(self.cat_tensors(self.cat_tensors(x_conv4_1_out, x_conv4_2_out), x_conv4_3_out), x_conv4_4_out)
