...
#2
PORT=$RANDOM
VER=second_da_nounet_halfbost2halfsing_novelo_PMA-0.1lr0.5_RCD-0.1lr0.5_FPN_Up1Down1_NoShare_Large_Transformer
# second_da_nounet_halfbost2halfsing_novelo_CDN
...
TASK_DESC=${VER}_${MOD}_CVPR_NEWFC
