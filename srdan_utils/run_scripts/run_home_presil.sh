...
VER=second_da_nounet_p2k_novelo_PMA-late-RCD-0.1_Up1Down1_NoShare_Large_all_cyclist
#_sep2da
...
#bost2sing
#_pseudo
CONFIG=./tools/cfgs/presil_models/${VER}.yaml
...
INST_DA=False
VIS=False
MOD=presil_${GPUNUM}GPU_4Batch_${MAX_EP}Ep_${PSEUDO_LABEL}pseudo_${PSEUDO_TRAIN_RATIO}ratio_${DOUBLE_TEST}2Test_${SELECT_PROP}SELECT_PROP
#_${L_POW}L_POW_${MCD_CURVE}mcd_curve_${L_Ratio}L_Ratio
#${BATCH_SIZE}
TASK_DESC=REAL_CYCLIST_ALL_${VER}_${MOD}
#$(date +'%d-%m-%y')_${VER}_${MOD}

OUT_DIR=/home/wzha8158/Lidar_Outputs_Presil/$TASK_DESC
