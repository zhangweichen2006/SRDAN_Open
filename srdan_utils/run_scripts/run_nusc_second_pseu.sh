...
VER=second_bost2sing_pseudo_0.3_128_balanced
...
MOD=nusc_dann_pseudo_reinit_${PSEUDO_TRAIN_RATIO}ratio_${GPUNUM}GPU_${BATCH_SIZE}Batch_$(date +'%d-%m-%Y')
