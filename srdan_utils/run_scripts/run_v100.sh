...
#2
PORT=$RANDOM
VER=second_da_nounet_sing2bost_novelo_PatchMatrixAttention-late-lr0.5_FPN_Up1Down1_NoShare_Large_TWOJOINTDOM_all
#
#_Large
...
SELECT_NEGPROP=0.1
#${DA_W}daW_
MOD=nusc_dann_${PSEUDO_LABEL}pseudo_reinit_${PSEUDO_TRAIN_RATIO}ratio_${GPU}GPU_8Batch_${SELECT_POSPROP}:${SELECT_NEGPROP}PseuProp
