...
#2
PORT=$RANDOM
VER=second_da_nounet_halfbost2halfsing_novelo_CDN_all
#_0.25loc
#_Self_Attention
#_2PMA_SepPMA
#second_da_nounet_halfbost2halfsing_novelo_PatchMatrixAttentionFIRST_RangeGuidanceDom_FPN_Up1Down1_NoShare_Large_BackToNormal_Single
#
#_Large
