...
VER=second_da_halfbost2helfsing_novelo_pseudo_0.3_512_balanced
...
MOD=nusc_${GPUNUM}GPU_${BATCH_SIZE}Batch_${MAX_EP}Ep_${PSEUDO_LABEL}pseudo_${PSEUDO_TRAIN_RATIO}ratio_${DOUBLE_TEST}2Test_${SELECT_PROP}PseuProp
#_dann
