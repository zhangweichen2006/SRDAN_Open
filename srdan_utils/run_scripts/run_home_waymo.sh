...
# ../waymo-open-dataset/bazel-bin/waymo_open_dataset/metrics/tools/compute_detection_metrics_main $OUT_DIR/eval/eval_last/epoch_28/my_preds.bin  data/Waymo/gt_val/gt_preds.bin
