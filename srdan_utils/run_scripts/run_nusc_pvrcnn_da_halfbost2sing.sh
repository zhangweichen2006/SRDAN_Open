...
VER=pv_second_halfbost2halfsing_novelo_da
#_pseudo
#
...
INST_DA=True
#${DA_W}daW_
MOD=$(date +'%d-%m-%Y')_nusc_dann_${PSEUDO_LABEL}pseudo_reinit_${PSEUDO_TRAIN_RATIO}ratio_${GPUNUM}GPU_${BATCH_SIZE}Batch_0103daw
